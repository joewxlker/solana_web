...
export default function HomePage(ctx: { params: { page_id: '2' }}) {

    const pageData = getPageData(ctx.params.page_id);
    const all_pages = getAllPagesExceptCurrentPage(ctx.params.page_id);
